...
<div class="input-block letak">
    ...
    <form name="input_data" action="simpan.php" method="post"> 
        <h1>LOKASI</h1>
        <input type="text" placeholder="Kode Toko" name="kd_toko"/>
        <input type="text" placeholder="Nama Toko" name="nama_toko"/>
        <input type="text" placeholder="Alamat" name="alamat" />
        <input type="text" placeholder="Kode Pos" name="kd_pos" />
...
<div class="input-block letak3">
    ...
    <form name="input_data" action="simpan3.php" method="post"> 
        <h1>BUKU</h1>
        <input type="text" placeholder="Kode Buku" name="kd_buku"/>
...
<a href="view3.php"><button id="tombol">Lihat Data</button></a>
